...
from ..models.update_workflow_payload_runs_on_incident_modes_item import (
    UpdateWorkflowPayloadRunsOnIncidentModesItem,
)
from ..models.update_workflow_payload_runs_on_incidents import (
    UpdateWorkflowPayloadRunsOnIncidents,
)
from ..models.update_workflow_payload_state import UpdateWorkflowPayloadState
...
if TYPE_CHECKING:
    ...
    from ..models.update_workflow_payload_annotations import (
        UpdateWorkflowPayloadAnnotations,
    )
    from ..models.workflow_delay import WorkflowDelay


T = TypeVar("T", bound="UpdateWorkflowPayload")


@_attrs_define
class UpdateWorkflowPayload:
    """
    Example:
    ...
    Attributes:
        ...
        steps (List['StepConfigPayload']): List of step to execute as part of the workflow Example: [{'for_each':
            ...
            'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
            'incident.severity'}}]}].
        annotations (Union[Unset, UpdateWorkflowPayloadAnnotations]): Annotations that track metadata about this
        ...
        shortform (Union[Unset, str]): Shortform used to trigger manual workflows in Slack - e.g. `/inc workflows page-
            ceo` Example: abc123.
        state (Union[Unset, UpdateWorkflowPayloadState]): The state of the workflow (e.g. is it draft, or disabled)
            Example: active.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for runs_on_incident_modes_item_data in _runs_on_incident_modes:
            runs_on_incident_modes_item = UpdateWorkflowPayloadRunsOnIncidentModesItem(
        ...
        annotations: Union[Unset, UpdateWorkflowPayloadAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = UpdateWorkflowPayloadAnnotations.from_dict(_annotations)
        ...
        state: Union[Unset, UpdateWorkflowPayloadState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = UpdateWorkflowPayloadState(_state)

        update_workflow_payload = cls(
            condition_groups=condition_groups,
            continue_on_step_error=continue_on_step_error,
            expressions=expressions,
            include_private_incidents=include_private_incidents,
        ...
        update_workflow_payload.additional_properties = d
