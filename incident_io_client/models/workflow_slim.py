...
from ..models.workflow_slim_runs_on_incident_modes_item import (
    WorkflowSlimRunsOnIncidentModesItem,
)
from ..models.workflow_slim_runs_on_incidents import WorkflowSlimRunsOnIncidents
from ..models.workflow_slim_state import WorkflowSlimState
...
class WorkflowSlim:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for runs_on_incident_modes_item_data in _runs_on_incident_modes:
            runs_on_incident_modes_item = WorkflowSlimRunsOnIncidentModesItem(
                runs_on_incident_modes_item_data
            )

            runs_on_incident_modes.append(runs_on_incident_modes_item)

        runs_on_incidents = WorkflowSlimRunsOnIncidents(d.pop("runs_on_incidents"))

        state = WorkflowSlimState(d.pop("state"))

        steps = []
        _steps = d.pop("steps")
        for steps_item_data in _steps:
            steps_item = StepConfigSlim.from_dict(steps_item_data)
        ...
        workflow_slim.additional_properties = d
