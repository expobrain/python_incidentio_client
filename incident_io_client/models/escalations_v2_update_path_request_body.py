...
T = TypeVar("T", bound="EscalationsV2UpdatePathRequestBody")


@_attrs_define
class EscalationsV2UpdatePathRequestBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        escalations_v2_update_path_request_body = cls(
            name=name,
            path=path,
            working_hours=working_hours,
        )

        escalations_v2_update_path_request_body.additional_properties = d
        return escalations_v2_update_path_request_body
