...
T = TypeVar("T", bound="SchedulesV2CreateResponseBody")


@_attrs_define
class SchedulesV2CreateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        schedules_v2_create_response_body = cls(
            schedule=schedule,
        )

        schedules_v2_create_response_body.additional_properties = d
        return schedules_v2_create_response_body
