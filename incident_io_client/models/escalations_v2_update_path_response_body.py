...
T = TypeVar("T", bound="EscalationsV2UpdatePathResponseBody")


@_attrs_define
class EscalationsV2UpdatePathResponseBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        escalations_v2_update_path_response_body = cls(
            escalation_path=escalation_path,
        )

        escalations_v2_update_path_response_body.additional_properties = d
        return escalations_v2_update_path_response_body
