...
T = TypeVar("T", bound="AlertRouteIncidentTemplatePayloadV2CustomFields")


@_attrs_define
class AlertRouteIncidentTemplatePayloadV2CustomFields:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        alert_route_incident_template_payload_v2_custom_fields = cls()
        ...
        alert_route_incident_template_payload_v2_custom_fields.additional_properties = (
            additional_properties
        )
        return alert_route_incident_template_payload_v2_custom_fields
