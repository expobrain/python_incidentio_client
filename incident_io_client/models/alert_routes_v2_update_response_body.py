...
T = TypeVar("T", bound="AlertRoutesV2UpdateResponseBody")


@_attrs_define
class AlertRoutesV2UpdateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        alert_routes_v2_update_response_body = cls(
            alert_route=alert_route,
        )

        alert_routes_v2_update_response_body.additional_properties = d
        return alert_routes_v2_update_response_body
