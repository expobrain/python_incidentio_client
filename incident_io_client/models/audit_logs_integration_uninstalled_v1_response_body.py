...
T = TypeVar("T", bound="AuditLogsIntegrationUninstalledV1ResponseBody")


@_attrs_define
class AuditLogsIntegrationUninstalledV1ResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        targets (List['AuditLogTargetV2']): The custom field that was created Example: [{'id': 'github', 'name':
            'Github', 'type': 'integration'}].
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        audit_logs_integration_uninstalled_v1_response_body = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_integration_uninstalled_v1_response_body.additional_properties = d
        return audit_logs_integration_uninstalled_v1_response_body
